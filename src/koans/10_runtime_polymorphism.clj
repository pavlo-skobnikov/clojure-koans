...
(defn hello
  ...
  ([a & more]
   (str "Hello to this group: "
        (apply str (interpose ", " (cons a more)))
        "!")))

(defn a-eats-y [a y] (str (:name a) " eats " y "."))
...
(meditations
  "Some functions can be used in different ways - with no arguments"
    (= "Hello World!" (hello))
  "With one argument" (= "Hello, you silly world." (hello "world"))
  "Or with many arguments" (= "Hello to this group: Peter, Paul, Mary!"
