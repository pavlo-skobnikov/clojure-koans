...
(meditations
  ...
  "Types are quite similar" (= "literature" (.prize (Pulitzer. "literature")))
  "Records may be treated like maps" (= "physics" (:prize (Nobel. "physics")))
  "While types may not" (= nil (:prize (Pulitzer. "poetry")))
  "Further study reveals why"
    (= '(true false) (map map? [(Nobel. "chemistry") (Pulitzer. "music")]))
  ...
  "Surely we can implement our own by now"
    (= "You're really the Worst Picture, Final Destination 5... sorry."
       (with-out-str (present (Razzie. "Worst Picture")
                              "Final Destination 5"))))
